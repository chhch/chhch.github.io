...
## deb http://ppa.launchpad.net/bryce/builds/ubuntu trusty main
## [Evtl: https://launchpad.net/~doctormo/+archive/ubuntu/wacom-plusxserver-xorg-input-wacom nicht genutzt!]
## http://linuxwacom.sourceforge.net/wiki/index.php?title=Consumer_Tablet_ExpressKey_Mapping_Issue
## Skript downloaden: https://gist.github.com/jigpu/fde784840ba5731726e7382952b0d5ed
