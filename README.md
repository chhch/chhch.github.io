...
- The template is based on Jekyll’s [minima theme](https://github.com/jekyll/minima) which is licensed under the [MIT License](https://github.com/jekyll/minima/blob/master/LICENSE.txt)
